...
[System.Serializable]public class nn 
{
    public Matrix<float> inputLayer = Matrix<float>.Build.Dense(1, 2);
    ...
    public void Initialise (int hiddenLayerCount, int hiddenNeuronCount)
    {
        ...
        for (int i = 0; i < hiddenLayerCount ; i++)
        {
            ...
            if (i == 0)
            {
                Matrix<float> inputToH1 = Matrix<float>.Build.Dense(2, hiddenNeuronCount);
    ...
    public void InitialiseHidden (int hiddenLayerCount, int hiddenNeuronCount)//to add
    {
        inputLayer.Clear();
        hiddenLayers.Clear();
        outputLayer.Clear();
    ...
    public float RunNetwork (float a, float b)
    {
        inputLayer[0, 0] = a;
        inputLayer[0, 1] = b;
